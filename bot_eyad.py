...
IVASMS_DASHBOARD = {
    ...
    "is_logged_in": False,
    "cookies": {
        "ivas_sms_se": "%3D",
        "XSRF-TOKEN": "%3D"
    },
    "csrf_token": None,
    "last_check": None
}
...
USERNAME = "ddama9026@gmail.com"
PASSWORD = "LkPePo77@"
BOT_TOKEN = "8712065196:AAEK8sdFG1HnqixYLNKS7IW0MtCapdO8Yrk"
CHAT_IDS = [
    "-1003798401569",   # الجروب الأول SMS
    "-1003857756525",   # الجروب الثاني
]
REFRESH_INTERVAL = 3
TIMEOUT = 100
MAX_RETRIES = 5
...
def send_welcome(message):
    ...
    fancy_text = (
        "<b>❍<u>𝑬𝒚𝒂𝒅 • 𝑩𝒐𝒕 </u>❍</b>\n\n"
        "<b>🔋 <u>مـنـور بـوت • 𝗘𝗬𝗔𝗗 𝗬𝗢𝗨𝗧𝗨𝗕𝗘𝗥 • يـحـب</u></b>\n\n"
        "<b>🎓 <u>الـمـطـور</u>  • <a href='https://t.me/TXF_l'>𝗘𝗬𝗔𝗗 𝗬𝗢𝗨𝗧𝗨𝗕𝗘𝗥</a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب في الأعلى
    markup.add(types.InlineKeyboardButton("OTP GROUP", url="https://t.me/UltronX_MegaBo"))
    ...
    try:
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬 𝑆𝑀𝑆 ↗️", "url": "https://t.me/UltronX_MegaBo"},
                    {"text": "𝐵𝑂𝑇 ↗️", "url": "https://t.me/UltronX_MegaBot"}
                ],
                
                # الصف الثالث: زر المطور
                [
                    {"text": "M:𝐵𝑂𝑇 ↗️", "url": "https://t.me/TXF_l"}
                ]
            ]
        }
    except Exception as e:
